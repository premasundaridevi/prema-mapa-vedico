    ...
    <>
      ...
      >
        <div style={{ width: "100%", maxWidth: 720, textAlign: "center" }}>
          ...
          <p style={{ color: C.verde, marginTop: 4, marginBottom: 20 }}>
            Esse é o primeiro passo para alinhar seu <b>Dharma</b> à sua vida
            profissional com o <b>método Prema Sundari.</b>
          </p>
          ...
          >
            ...
            {err && (
              <p style={{ color: "#B42318", fontSize: 13, marginTop: 6 }}>
                {err}
              </p>
            )}
          </form>
          ...
          {resp && (
            ...
            >
              ...
              <div style={{ color: C.verde, fontSize: 14, marginTop: 12 }}>
                Na leitura completa, conecto <b>Casa 10</b> (carreira), <b>Sol</b>{" "}
                (liderança) e <b>Saturno</b> (método) para próximos passos
      ...
      >
        ...
        <div style={{ fontSize: 12, opacity: 0.75, marginTop: 8 }}>
          © {new Date().getFullYear()} Prema Sundari · Astrologia Védica para
          negócios femininos
        </div>
      </footer>
    </>
